...
namespace ECommerceAPI.Migrations
{
    ...
    [Migration("20250709093233_Adding IsReadByAdmin and IsReadByCustomer properties in ContactMessage entity")]
    partial class AddingIsReadByAdminandIsReadByCustomerpropertiesinContactMessageentity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerceAPI.Models.ContactMessage", b =>
                {
                    ...
                    b.Property<string>("IsReadByAdmin")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("IsReadByCustomer")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ECommerceAPI.Models.ContactMessage", b =>
                {
                    b.HasOne("ECommerceAPI.Models.ApplicationUser", "RepliedBy")
                        .WithMany("RepliedMessages")
                        .HasForeignKey("RepliedById")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("ECommerceAPI.Models.ApplicationUser", "Sender")
